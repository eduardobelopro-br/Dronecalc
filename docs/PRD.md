...
- testes automatizados do motor matemático, da Bancada, do recomendador e do pipeline crítico de ingestão.
...
A recomendação básica sobre candidatos do catálogo faz parte do produto; a otimização global/avançada permanece posterior ao MVP.
...
### RNF-01 — Determinismo
Mesmas entradas e mesma versão do motor devem produzir os mesmos resultados e o mesmo ranking.

### RNF-02 — Testabilidade
O motor matemático e o recomendador não podem depender de React ou DOM.

### RNF-03 — Rastreabilidade
Cálculos críticos devem registrar fórmula/modelo, entradas e versão do algoritmo. Imports automáticos e dados de bancada devem registrar fonte, método e evidência/proveniência quando aplicável. Rankings devem registrar perfil/versão, candidatos avaliados e razões determinantes.

### RNF-04 — Performance
Alterações simples do projeto devem atualizar a análise sem atraso perceptível em hardware desktop comum. Processos de ingestão/IA podem ser assíncronos e devem expor estado/progresso adequado. O recomendador inicial deve trabalhar com conjunto limitado de candidatos sem exigir otimização global.
...
11. receber alertas elétricos explicáveis;
12. duplicar a configuração e comparar uma bateria, motor ou hélice diferente;
13. fechar e reabrir a aplicação sem perder o projeto/dados persistidos.
